package com.greatlearning.studentDebateRest.controller;
...
import com.greatlearning.studentDebateRest.service.StudentService;
...
public class StudentController {
	...
	public ModelAndView accessDenied(Principal user) {
		...
		if (user != null) {
			modelAndView.addObject("msg", "Hello  " + user.getName() + ", " + " You dont have necessary permissions to access this page");
		} else {
